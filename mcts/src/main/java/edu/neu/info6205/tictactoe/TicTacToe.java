...
public class TicTacToe implements Game<TicTacToe> {
    ...
    public static void main(String[] args) {
        // NOTE the behavior of the game to be run will be based on the TicTacToe
        // instance field: random.
    ...
    /**
     * This method determines the opening player (the "white" by analogy with
     * chess).
